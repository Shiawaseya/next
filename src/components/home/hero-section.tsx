...
export function HeroSection() {
  ...
  return (
    <>
      ...
      {/* Main Hero Content */}
      <div className="flex items-center justify-center min-h-screen -mt-16 px-6 z-10 relative">
        <motion.div
        ...
        >
          ...
          >
            A robust starting point featuring complete authentication, animated
            layouts, theme switching, RTL support, and gorgeous minimal design
            out of the box.
          </motion.p>
