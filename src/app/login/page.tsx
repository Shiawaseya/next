      ...
      >
        <div className="text-center">
          <motion.div
            ...
            className="mx-auto w-16 h-16 bg-primary/10 text-primary rounded-2xl flex flex-col items-center justify-center font-bold text-xl mb-6 ring-1 ring-primary/20 backdrop-blur-md"
          >
            <Image
              src="/n2a1.png"
              width={500}
        ...
        <form className="mt-8 space-y-6" onSubmit={handleLogin}>
          ...
          <div className="space-y-4">
            ...
            >
              <label
                htmlFor="username"
                className="block text-xs font-medium text-muted-foreground uppercase tracking-wider mb-1.5 ml-1"
              >
                Username
              </label>
              <input
